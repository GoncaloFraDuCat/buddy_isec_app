...
ActiveRecord::Schema[7.1].define(version: 2024_04_04_145414) do
  ...
  create_table "mentorship_requests", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "status"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "mentee_id"
    t.bigint "mentor_id"
    t.index ["mentee_id"], name: "fk_rails_4c315c1ed7"
    t.index ["mentor_id"], name: "fk_rails_70cfa969d9"
  end
